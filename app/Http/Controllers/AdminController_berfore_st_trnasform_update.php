    ...
    public function GetGeom(Request $request)
    {
        ...
        switch ($level) {
            ...
            case "forMauza":
                ...
                $sql = "SELECT DISTINCT plot_no_en as gid, plot_no_bn as label,m_code,plot_no_en,st_astext(st_transform(geom,4326)) as geom FROM ".$tableName."_mg WHERE \"substring\"(geocode_en::text, 0, 13) = '$mauzaVal' ORDER BY plot_no_en";
                $plots=DB::select($sql);

                $sql = "SELECT DISTINCT plot_no_en,m_code,plot_no_en,maj_class,sub_class,st_astext(st_transform(geom,4326)) as geom FROM ".$tableName."_ml WHERE \"substring\"(geocode_en::text, 0, 13) = '$mauzaVal' ORDER BY plot_no_en";
            ...
            case "forSheet":
                ...
                if($sheetVal == null) {
                    $sql = "SELECT DISTINCT plot_no_en as gid,m_code, plot_no_bn as label,plot_no_en,st_astext(st_transform(geom,4326)) as geom FROM ".$tableName."_mg WHERE \"substring\"(geocode_en::text, 0, 13) = '$mauzaVal' ORDER BY plot_no_en";
                    $result=DB::select($sql);
                }
                else {
                    $sql = "SELECT DISTINCT plot_no_en as gid,m_code, plot_no_bn as label,plot_no_en,st_astext(st_transform(geom,4326)) as geom FROM ".$tableName."_mg WHERE \"substring\"(geocode_en::text, 0, 13) = '$mauzaVal' AND sht_no_en = '$sheetVal' ORDER BY plot_no_en";
                    $result=DB::select($sql);
                }

                $sql = "SELECT DISTINCT plot_no_en as gid,m_code, plot_no_bn as label,maj_class,sub_class,plot_no_en,st_astext(st_transform(geom,4326)) as geom FROM ".$tableName."_ml WHERE \"substring\"(geocode_en::text, 0, 13) = '$mauzaVal' AND sht_no_en = '$sheetVal' ORDER BY plot_no_en";
            ...
            case "forPlot":
                ...
                $sql = "SELECT DISTINCT plot_no_en as gid,m_code, plot_no_bn as label,sht_no_en,plot_no_en,st_astext(st_transform(geom,4326)) as geom FROM ".$tableName."_mg WHERE \"substring\"(geocode_en::text, 0, 13) = '$mauzaVal' AND plot_no_en = '$plotVal' ORDER BY plot_no_en";
                $plot=DB::select($sql);
