    ...
    <div class="content menu-contain">
        ...
        <div class="row">
            <div class="col-md-12">
                <!-- Menus Create Labels -->
                <div class="block">
                    <form action="{{ route('admin.menus.store') }}" method="POST" enctype="multipart/form-data" role="form">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <label class="font-weight-bold">Menu Icon</label>
                                        <br>
                                        <span>
                                            <input type="radio" id="icon1" name="icon" value="fa fa-bar-chart" />
                                        ...
                                        {{--<input type="file" name="icon" id="icon" class="form-control height-unset" accept=".jpg,.jpeg,.bmp,.png,.gif" required>--}}
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="form-group">
