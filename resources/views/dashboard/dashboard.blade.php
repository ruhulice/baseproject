...
@section('content')
    ...
    <div class="bg-body-light border-b">
        ...
        <nav class="breadcrumb bg-body-light mb-0" id="geoLocationBC">
                ...
                <a class="breadcrumb-item" href="{{ route('dashboard') }}">Division Dashboard</a>
            </nav>
        </div>
    </div>
    <!-- END Breadcrumb -->
    ...
    <div class="content" style="padding: 5px !important;">
        <div class="row js-appear-enabled animated fadeIn" data-toggle="appear">
            ...
            {{-- <div class="col-md-12">
                <div class="Container">
                    <h3 style="margin-bottom: 0px" class="Head">বিভাগ অনুসারে আপলোডেড মৌজা ও সিট সংখ্যাঃ<span class="Arrows"></span></h3>
                    <!-- Carousel Container -->
                      ...
                      <div class="ProductBlock">
                        <a class="block block-rounded block-bordered block-link-shadow" href="javascript:void(0)">
                            <div class="block-content block-content-full clearfix">
                                ...
                                <div class="font-size-h3 font-w600 text-earth">{{$item->m_div_bn}}</div>
                      ...
                      <div class="ProductBlock">
                        <a class="block block-rounded block-bordered block-link-shadow" href="javascript:void(0)">
                            <div class="block-content block-content-full clearfix">
                                ...
                                <div class="font-size-h3 font-w600 text-earth"><span data-toggle="countTo" data-speed="1000" data-to="780" class="js-count-to-enabled">মোট বিভাগ</span></div>
                                <div class="font-size-sm font-w600 text-uppercase text-muted"><span class="count-osk">{{$counts[0]->div}}</span></div>
                            </div>
                        </a>
                      </div>
                      <!-- Item -->
        ...
        {{-- <script>
            $(document).ready(function(){
                ...
                data.forEach(item =>{
                    ...
                    $data = [];
                    var divDetails = result.filter(x=> x.maj_class === item.maj_class && x.majclass_b === item.major_class);
                    ...
                    console.log($majorclassColumnChartData);
                });
