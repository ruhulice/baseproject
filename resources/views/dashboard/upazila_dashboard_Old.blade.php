...
.page-link {
    ...
    <div class="bg-body-light border-b">
        ...
        <nav class="breadcrumb bg-body-light mb-0" id="geoLocationBC">
                ...
                <a class="breadcrumb-item" href="{{ url('/district-dashboard') }}">Thana/Upazila Dashboard</a>
        </nav>
        </div>
    </div>
    <!-- END Breadcrumb -->
        ...
        <script>
            $(document).ready(function(){
                ...
                data.forEach(item =>{
                    ...
                    $visible = false;
                    if(item.maj_class.toLowerCase().includes('residential') || item.maj_class.includes('bodies') || item.maj_class.includes('agricultural')){
                        $visible = true;
                    }
