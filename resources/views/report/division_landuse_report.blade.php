...
@section('content')
    ...
    <div class="bg-body-light border-b">
        ...
        <nav class="breadcrumb bg-body-light mb-0">
                ...
                <a class="breadcrumb-item" href="{{ url('/report/division-landuse') }}">Division wise Landuse</a>
            </nav>
        </div>
    </div>
    <!-- END Breadcrumb -->
        ...
        <div class="block" style="padding: 0px; margin-bottom:0px;">
            <div class="block-content block-content-full">
                <div class="block-content" style="overflow-y: auto">
                    <h5 class="text-center">Division wise Landuse</h3>
            ...
            $(document).ready(function(){
                ...
                var loadDataList = function (areaCode){
                    ...
                    $('#datatable').DataTable({
                        ...
                        ajax: {
                            "url": "/report/division-landuse/json/" + areaCode,
                            "type": "GET",
                            "dataSrc": "",
                        },
                        columns: [
