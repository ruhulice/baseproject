...
@section('content')
    ...
    <div class="bg-body-light border-b">
        ...
        <nav class="breadcrumb bg-body-light mb-0">
                ...
                <a class="breadcrumb-item" href="{{ url('/report/division-zoning') }}">Division wise Zoning</a>
            </nav>
        </div>
    </div>
    <!-- END Breadcrumb -->
            ...
            $(document).ready(function(){
                ...
                var loadDataList = function (areaCode){
                    ...
                    $('#datatable').DataTable({
                        ...
                        ajax: {
                            "url": "/report/division-zoning/json/" + areaCode,
                            "type": "GET",
                            "dataSrc": "",
                        },
                        columns: [
