    ...
    <div class="bg-body-light border-b">
        <div class="content py-5 text-center" >
            <nav class="breadcrumb bg-body-light mb-0">
                ...
                <a class="breadcrumb-item" href="{{ url('/report/upazilla-zoning') }}">Upazilla wise Zoning</a>
            </nav>
        </div>
    </div>
    <!-- END Breadcrumb -->
        ...
        <div class="block" style="padding: 0px; margin-bottom:0px;">
            <div class="block-content block-content-full">
                <div class="block-content" style="overflow-y: auto">
                    <h5 class="text-center">Upazilla wise Zoning</h3>
            ...
            $(document).ready(function(){
                ...
                var loadDataList = function (areaCode){
                    ...
                    $('#datatable').DataTable({
                        ...
                        ajax: {
                            "url": "/report/upazilla-zoning/json/" + areaCode,
                            "type": "GET",
                            "dataSrc": "",
                        },
                        columns: [
