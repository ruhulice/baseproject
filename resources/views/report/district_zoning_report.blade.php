...
@section('content')
    ...
    <div class="bg-body-light border-b">
        ...
        <nav class="breadcrumb bg-body-light mb-0" >
                ...
                <a class="breadcrumb-item" href="{{ url('/report/district-zoning') }}">District wise Zoning</a>
            </nav>
        </div>
    </div>
    <!-- END Breadcrumb -->
        ...
        <div class="block" style="padding: 0px; margin-bottom:0px;">
            <div class="block-content block-content-full">
                <div class="block-content" style="overflow-y: auto">
                    <h5 class="text-center">District wise Zoning</h3>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-left" >জেলা কোড</th>
            ...
            $(document).ready(function(){
                ...
                var loadDataList = function (areaCode){
                    ...
                    $('#datatable').DataTable({
                        ...
                        ajax: {
                            "url": "/report/district-zoning/json/" + areaCode,
                            "type": "GET",
                            "dataSrc": "",
                        },
                        columns: [
