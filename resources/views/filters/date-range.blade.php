<div class="form-group" id="date_input">
    ...
    <div class="col-sm-8 input-group date input-daterange">
        ...
        {{Form::text('from_date',date("Y-m-d"), ['placeholder'=>'','autocomplete'=>'off','class' => "form-control", 'id'=>'from_date'])}}
        <span class="input-group-addon"><i class="fa fa-calendar"></i>&nbsp;To</span>
        {{Form::text('to_date',date("Y-m-d"), ['placeholder'=>'','autocomplete'=>'off','class' => "form-control", 'id'=>'to_date'])}}
    </div>
</div>