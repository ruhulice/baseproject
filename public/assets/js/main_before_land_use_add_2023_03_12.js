          ...
          $.ajax({
              ...
              success: function (data) {
                  ...
                  for(var i=0; i<data.length; i++){
                    console.log(data[i]);
                      var label = data[i].label;
                      var mcode  = data[i].m_code;
                      var dt = data[i].geom;
                      var opt = $("<option></option>").attr("value", data[i].gid).text(label);
    ...
    <div class="portlet-body">
      ...
      function showInfo(lang,e){
        ...
        if(lang =='en'){
            ...
            if(typeof($pltoInfo.majclass_b) !=='undefined'){
                //html +='<tr><td>প্রধান শ্রেণী</td><td>'+$pltoInfo.majorclass_bn+'</td></tr>';
                html +='<tr><td>প্রধান শ্রেণী</td><td>'+$pltoInfo.majclass_b+'</td></tr>';
            }
            if(typeof($pltoInfo.subclass_b) !=='undefined'){
                html +='<tr><td>উপ শ্রেণী</td><td>'+$pltoInfo.subclass_b+'</td></tr>';
            }
...
//         $mcode = feature.C.m_code;
//         if($mcode != ""){
//             $layerName = "mv_"+$mcode.substr(0,7).toLowerCase()+"_ml";
//             console.log($layerName);
//             if($layerName != ""){

//                 var viewReg = map.getView().getResolution();
//                 var dist = 0.5 / 111.325 * viewReg;
//                 var layer = plotLanduseLayer;
//                 console.log(layer);
//                 $.ajax({
//                     url: geoServerBase2+'wfs/',
//                     type: 'POST',
//                     data: {
//                         request: 'GetFeature',
//                         version: '1.0.0',
//                         typeName: 'wsDMMS:'+$layerName,
//                         srsName: layer.get('srsName'),
//                         outputFormat: 'GML2',
...
//                             '</gml:coordinates>' +
//                             '</gml:Point>' +
//                             '<Distance units="kilometers">' + dist + '</Distance>' +
//                             '</DWithin>' +
//                             '</Filter>'
//                     },
//                     success: function (data) {
...
//                         if (gmlFormat.readFeatures(data)[0]) {
//                             console.log(gmlFormat.readFeatures(data)[0]);
//                             $pltoInfo = gmlFormat.readFeatures(data)[0].C;
//                             console.log($plotNo);
...
//                                 setTimeout(function(){
//                                     $('.ui-dialog').css('top','130px');
//                                 },750);
                           
//                             //selectInteraction.getFeatures().push(gmlFormat.readFeatures(data)[0]);
    ...
    plotVectorLayer.getFeatures(pixel).then(function (features) {
        ...
        if($mcode != ""){
            ...
            if($layerName != ""){
                ...
                //                 padding: 0.25rem 1rem;
                //             }</style>
                //             <h5 style="margin-bottom:7px;color:#ff9900;">ভূমি তথ্য বিবরণঃ <button type="button" title="Share Plot Info" onclick="shareInfo()" class="btn btn-outline-primary" style="float:right;font-size: 1.2em;border-radius: 5px; padding: 0.375rem 0.75rem;"><i class="fa fa-share-alt"></i> </button><button type="button" title="Share Plot Info" onclick="shareQRCodeInfo()" class="btn btn-outline-primary" style="float:right;font-size: 1.2em;border-radius: 5px; padding: 0.375rem 0.75rem; margin-right:5px"><i class="fa fa-qrcode"></i> </button></h5>
                //             <div class="col-md-12" style="padding:0px;"><ul class="nav nav-tabs">
                //                 <li class="nav-item">
                //                 <a role="button" onClick="showInfo('bn',this)" class="nav-link active" data-bs-toggle="tab">বাংলা</a>
                //             </li>
                ...
                //                 <a role="button" onClick="showInfo('en',this)" class="nav-link" data-bs-toggle="tab">English</a>
                //                 </li>
                //                 <li class="nav-item feedback-tab">
                //                 <a role="button" onClick="showInfo('feedback',this)" class="nav-link" data-bs-toggle="tab">Feedback</a>
                //                 </li>
                //                 <li class="nav-item feedback-login-tab">
                //                 <a role="button" onClick="showInfo('feedback-login',this)" class="nav-link" data-bs-toggle="tab">Feedback</a>
                //                 </li>
                //                 </ul>
                //                 <div class="tab-content">
                //                 <div class="tab-pane fade show active">
...
//   });
    ...
    //   });
      ...
      map.on('singleclick', function (evt) {
        ...
        if(sheetVal != null || plotVal != null){
            displayFeatureInfo(evt.pixel,evt);
        }
        else{
           //swal.fire('Please select mouza sheet or plot first');
           toastr.warning('Please select mouza sheet or plot first');
        }
